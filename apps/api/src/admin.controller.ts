...
const allowedStatuses = ['NEW', 'WAITING_FOR_PRICING', 'PRICED', 'APPROVED', 'REJECTED', 'COMPLETED', 'CANCELLED'] as const
class StatusDto { @IsString() @IsIn(allowedStatuses) status!: (typeof allowedStatuses)[number] }
@Controller('admin')
